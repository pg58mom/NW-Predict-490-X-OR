...
#    print '    Deriv-F(0): ', '     %.3f' % transFuncDeriv0, '   Deriv-F(1): ', '     %.3f' % transFuncDeriv1
    ...
    print ' ' 
    print 'The computed values for the deltas are: '
    print '                eta  *   trFncDeriv    *   input    * SumTerm for given H'
    print '  deltaWWt00 = ',' %.2f' % eta, ' * %.4f' % transFuncDerivHidden0, '  * %.4f' % inputNode0, '  * %.4f' % sumTermH0
    print '  deltaWWt01 = ',' %.2f' % eta, ' * %.4f' % transFuncDerivHidden1, '  * %.4f' % inputNode0, '  * %.4f' % sumTermH1                       
    print '  deltaWWt10 = ',' %.2f' % eta, ' * %.4f' % transFuncDerivHidden0, '  * %.4f' % inputNode1, '  * %.4f' % sumTermH0
    print '  deltaWWt11 = ',' %.2f' % eta, ' * %.4f' % transFuncDerivHidden1, '  * %.4f' % inputNode1, '  * %.4f' % sumTermH1
    print ' '
...
#   and so is not included explicitly in these equations
    ...
    transFuncDerivHiddenList, transFuncDerivOutputList, deltaWWtArray, vWeightArray, wWeightArray, newWWeightArray)     
...
# Parameter definitions, to be replaced with user inputs
    ...
    summedInput = 1
    maxNumIterations = 2    # temporarily set to 10 for testing
